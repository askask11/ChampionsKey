        ...
        <table class="table table-striped table-striped-nth-even-bluebg">
            ...
            <c:choose>
                <c:when test="${empty attandance}">
                    <%--IF there is no active attendance currently, it is impossible to have the conflict.--%>
                        ...
                        <td>
                            ...
                            <td>
                                <form action="AttandanceStudentEmbedded" method="GET" class="inline-block">
                                    ...
                                    <button type="submit" class="transparentButton" onmouseover="notify('Edit the attendance record of this class.')"><img src="images/icons/edit32.svg" alt="edit"></button>
                                </form>
                                ...
                                <button class="transparentButton" type="submit" title="Resume this class. After you click on this button, this class will be active again." onmouseover="notify(this.title)"><span class="icon-32 blue">&#9654;</span></button>
                            </form>
                            ...
                            <form action="HistoryAttandanceEmbedded" method="GET" class="inline-block ${attendance.getAttandanceID()==currentId?"hide":""}">
                                <input value="<c:out value="${attendance.getAttandanceID()}"></c:out>" name='id' type="hidden">
                                    ...
                                    <button type="submit" class="transparentButton" title="Delete this line of history and all student's attendance record associated with it." onmouseover="notify(this.title)"><img src="images/icons/x16.svg" alt="delete" class="icon-32" ></button>
                                </form>  
                            </td>
                        </tr>
